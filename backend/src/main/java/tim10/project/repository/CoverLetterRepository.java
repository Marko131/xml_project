...
public class CoverLetterRepository {
    ...
    public CoverLetter getById(String collectionId, String documentId) throws XMLDBException, JAXBException {
    ...
    public ArrayList<CoverLetter> getAll(String collectionId) throws XMLDBException, JAXBException {
        ArrayList<CoverLetter> list = new ArrayList<CoverLetter>(){};
        Collection col = DatabaseManager.getCollection(this.getUri() + collectionId);
        col.setProperty(OutputKeys.INDENT, "yes");
        for (String element: col.listResources()) {
            ...
            if (res == null) {
                ...
                list.add((CoverLetter) unmarshaller.unmarshal(res.getContentAsDOM()));
            }
        }
        try {
            col.close();
